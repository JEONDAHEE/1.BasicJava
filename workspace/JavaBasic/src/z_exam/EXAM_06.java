...
public class EXAM_06 {
	public static void main(String[] args) {
		...
		----------------------------------------------------------------
		   ...
		   [6-2] 문제 6-1에서 정의한 클래스에 두 개의 생성자와 info()를 추가해서 실행결과와 같은 결과를 얻도록 하시오.
			...
			[6-8] 다음의 코드에 정의된 변수들을 종류별로 구분해서 적으시오. 
				class PlayingCard { 
					...
					public static void main(String args[]//지역변수 ) {  
						PlayingCard card//지역변수 = new PlayingCard(1,1); 
					} 
				}
		=>==============================================================
				- 클래스변수(static변수) : 
				...
				- 지역변수  :args, card
		----------------------------------------------------------------
			[6-9] 다음은 컴퓨터 게임의 병사 를 (marine)클래스로 정의한 것이다. 이 클래스의 멤버중에 static을 붙여야 하는 것은 어떤 것들이고 그 이유는 무엇인가? 
		...
		----------------------------------------------------------------
			[6-17] 호출스택이 다음과 같은 상황일 때 옳지 않은 설명은? (모두 고르시오)
				...
				b. 메서드를 제외한 나머지 메서드들은 모두 종료된 상태이다.
				c. methid2메서드를 호출한 것은 메서드이다. 
				d. println메서드가 종료되면 method1메서드가 수행을 재개한다.
				e. main-method2-method1-println의 순서로 호출되었다.
				f. 현재 실행중인 메서드는 prinln뿐이다.
		=>==============================================================
			b
		----------------------------------------------------------------
